...
func Load() (*Config, error) {
	cfg := &Config{
		...
		PostgresURL:   getEnvOrDefault("POSTGRES_URL", "postgres://postgres:postgres@localhost:5432/svaani?sslmode=disable"),
		...
		KeycloakIssuer:   getEnvOrDefault("KEYCLOAK_ISSUER", "http://localhost:8080/realms/svaani"),
